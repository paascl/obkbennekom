  ...
  <body>
    <div class="navbar-wrapper">
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
               <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">De vereniging <b class="caret"></b></a>
               ...
               <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Nieuws<b class="caret"></b></a>
                  <ul class="dropdown-menu">
      ...
      <div class="form-group">
        <input type="text" class="form-control" placeholder="Nieuwsarchief">
      </div>
      <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
    </form> 
      <button type="button" class="btn btn-default btn-sm navbar-right navbar-btn" >Login</button>
          </div>
          </div>
         </div>
        </div>
